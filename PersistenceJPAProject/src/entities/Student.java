...
@NamedQueries({
	...
	@NamedQuery(name = "Student.findById" , query = "SELECT s FROM Student s WHERE s.idStudent = :studentID"),
	@NamedQuery(name = "Student.DeleteById" , query = "DELETE FROM Student s WHERE s.idStudent = :studentID")
})
